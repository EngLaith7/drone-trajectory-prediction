...
# ======================
# 1. Load cleaned dataset (variables, not file)
# ======================
df = get_cleaned_data()
...
# ======================
# 3. Normalize features and outputs
# ======================
...
joblib.dump(scaler_y, Path("scaler_y.pkl"))
...
def create_windows(X, y, window_size=50):
    ...
    for i in range(len(X) - window_size):
        ...
        ys.append(y[i+window_size])                # predict next timestep
...
# ======================
joblib.dump(model, Path("drone_model.pkl"))
